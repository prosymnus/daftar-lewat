...
<!-- ***********************************************************************************************************   -->
 ...
 <!-- semua medan yang diambil dari db2 utk pass to controllers -->
    <!--      <input name="id_type" type="hidden" value="<?php echo $db2_icno; ?>">   jenis id ibu  -->
...
<!--  *********************************************************************************************************** -->
   ...
   <?php echo $db2_name ?>
      <?php echo $db2_NTNLY ?>
         <?php echo $db2_cit_stat ?>
            <?php echo $db2_MAR_STAT ?>
...
<tr>
             ...
             <td><strong>:&nbsp;</strong></td>
                ...
                <td width="10"><input maxlength="12" type="ibu_id"  class=""  name="mykad" id="ibu_id" value="<?php echo $db2_icno; ?>"?> </td>
                <td>  <button type="submit" class=""> pertanyaan </button> </td>
</tr>
            ...
            <td height="36"><strong> Jenis Pengenalan Ibu</strong></td>   
              <td><strong>:&nbsp;</strong></td> 
                 <td width="475"> <input type="hidden" name="jenis_id_ibu"  value="$jenis_id_ibu">
                        <?php if (isset($jenis_id_ibu)) {  echo get_idtype_combo_mo("DCTY","jenis_id_ibu",$jenis_id_ibu); } else { echo get_idtype_combo_mo("DCTY","jenis_id_ibu",set_value('')); } ?>
                          </td>
</tr>
            ...
            <td height="36"><strong> Negara Pengeluar Pengenalan Ibu</strong></td>   
              <td><strong>:&nbsp;</strong></td> 
                 <td width="475"> <input type="hidden" name="negara_id_ibu"  value="$negara_id_ibu">
                        <?php if (isset($db2_NTNLY)) {  echo get_idctry_combo_mo("NGR","negara_id_ibu",$db2_NTNLY); } else { echo get_idctry_combo_mo("NGR","negara_id_ibu",set_value('$ctry_cd')); } ?>
                          </td>
</tr>
            ...
            <td height="36"><strong> Warganegara Ibu</strong></td>   
              <td><strong>:&nbsp;</strong></td> 
                 <td width="475"> <input type="hidden" name="warganegara_ibu"  value="$warganegara_ibu">
                        <?php if (isset($db2_cit_stat)) {  echo get_cit_combo_mo("CIT","warganegara_ibu",$db2_cit_stat); } else { echo get_cit_combo_mo("CIT","warganegara_ibu",set_value('<?php echo $db2_cit_stat ?>')); } ?>
                          </td>
...
<tr>
              ...
              <td width="10"><strong>:&nbsp;</strong></td>
                 <td width="475"> <input type="hidden" name="status_perkahwinan"  value="$status_perkahwinan">
                        <?php if (isset($db2_MAR_STAT)) {  echo get_marstat_combo("MAR","status_perkahwinan",$db2_MAR_STAT); } else { echo get_marstat_combo("MAR","status_perkahwinan",set_value('<?php echo $db2_MAR_STAT ?>')); } ?>
                          </td>
</tr>
