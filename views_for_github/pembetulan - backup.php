...
<tr>
             ...
             <td width="10"><strong>:&nbsp;</strong></td>
                <td width="475"><input type="namapenganjur1"  class="input-efast"  name="namapenganjur1" id="namapenganjur1" value="<?php echo $namapenganjur1 ?> "?> </td>
</tr>
...
<tr>
             ...
             <td><strong>:&nbsp;</strong></td>
                <td width="475"><input maxlength="12" type="nokppenganjur1"  class="input-efast"  name="nokppenganjur1" id="nokppenganjur1" value="<?php echo $nokppenganjur1 ?> "?> </td>
</tr>
